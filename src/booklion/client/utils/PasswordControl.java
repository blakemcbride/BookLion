 ...
 * Date: 5/7/14
 */
public class PasswordControl  extends PasswordField implements HandleErrorProcessing {
    ...
    public PasswordControl(int min, int max, String name) {
        minLength = min;
        maxLength = max;
...
//	public PasswordControl setRange(int min, int max, String name) {
//		minLength = min;
//		maxLength = max;
//		ctlName = name.replaceAll(":", "");
//		errorParametersSpecified = true;
