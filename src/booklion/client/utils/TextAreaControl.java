 ...
 * Date: 1/14/14
 */
public class TextAreaControl extends TextArea implements HandleErrorProcessing {
    ...
    public TextAreaControl(int min, int max, String name) {
        minLength = min;
        maxLength = max;
...
//	public TextAreaControl setRange(int min, int max, String name) {
//		minLength = min;
//		maxLength = max;
//		ctlName = name.replaceAll(":", "");
//		errorParametersSpecified = true;
