...
@Entity
@Table(name="chapter_h")
public class ChapterH implements Serializable {

	private static final long serialVersionUID = 1L;

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(ChapterH.class);
...
//    @GeneratedValue(strategy=GenerationType.IDENTITY)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="chapter_h_history_id_seq")
    @SequenceGenerator(name="chapter_h_history_id_seq", sequenceName="chapter_h_history_id_seq", allocationSize=1)
