...
@Entity
@Table(name="location_log_h")
public class LocationLogH implements Serializable {

	private static final long serialVersionUID = 1L;

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(LocationLogH.class);
...
//    @GeneratedValue(strategy=GenerationType.IDENTITY)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="location_log_h_history_id_seq")
    @SequenceGenerator(name="location_log_h_history_id_seq", sequenceName="location_log_h_history_id_seq", allocationSize=1)
