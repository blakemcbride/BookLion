...
@Entity
@Table(name="login_user_h")
public class LoginUserH implements Serializable {

    private static final long serialVersionUID = 1L;

    @SuppressWarnings("unused")
    private static final Logger logger = Logger.getLogger(LoginUserH.class);
...
//    @GeneratedValue(strategy=GenerationType.IDENTITY)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="login_user_h_history_id_seq")
    @SequenceGenerator(name="login_user_h_history_id_seq", sequenceName="login_user_h_history_id_seq", allocationSize=1)
