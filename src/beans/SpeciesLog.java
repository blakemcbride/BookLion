...
@Entity
@Table(name="species_log")
public class SpeciesLog implements Serializable {

    public static final String SPECIES_LOG_ID = "speciesLogId";
	...
	private static final Logger logger = Logger.getLogger(SpeciesLog.class);
...
//    @GeneratedValue(strategy=GenerationType.IDENTITY)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="species_log_species_log_id_seq")
    @SequenceGenerator(name="species_log_species_log_id_seq", sequenceName="species_log_species_log_id_seq", allocationSize=1)
