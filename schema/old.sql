...
CREATE TABLE login_user (
    ...
    user_banned character(1) DEFAULT 'N'::bpchar NOT NULL,
    CONSTRAINT login_user_admin_chk CHECK (((administrator = 'N'::bpchar) OR (administrator = 'Y'::bpchar))),
    CONSTRAINT login_user_banned_chk CHECK (((user_banned = 'Y'::bpchar) OR (user_banned = 'N'::bpchar))),
...
--
-- Name: COLUMN login_user.user_banned; Type: COMMENT; Schema: public; Owner: postgres
--
